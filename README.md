...
This is the branch to eventually implement a Sionna 2.+ compatible version of OpenNTN. At the moment, this branch is not yet tested. Using it might result in unforseen bugs.
