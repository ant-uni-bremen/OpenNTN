...
# Table 6.7.2-3a: Channel model parameters for Urban Scenario (LOS) at S band
    def test_s_band_dl(self):
        ...
        for elevation_angle in [10.0,20.0,30.0,40.0,50.0,60.0,70.0,80.0,90.0]:
            ...
            difference = tf.abs(difference) < 1e-5
...
# Values taken from Table 6.7.2-8a: Channel model parameters for Urban Scenario (NLOS) at S band and 
# Table 6.7.2-7a: Channel model parameters for Urban Scenario (LOS) at S band
    def test_s_band_dl(self):
    ...
    # Values from tables Table 6.7.2-8b: Channel model parameters for Rural Scenario (NLOS) in Ka band
    # and Table 6.7.2-7b: Channel model parameters for Rural Scenario (LOS) in Ka band
