...
from sionna.channel.tr38811.utils import compute_satellite_speed
...
class Topology:
    ...
    def __init__(self,  velocities,
        ...
        # self.sat_speed = None
        # if tf.reduce_any(tf.greater_equal(bs_height, 600000.0)):
