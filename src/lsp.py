...
class LSPGenerator:
    ...
    def _compute_lsp_spatial_correlation_sqrt(self):
        ...
        # Correlation matrix
        spatial_lsp_correlation = (tf.math.exp(ut_dist_2d*distance_scaling_matrices)*filtering_matrices)#here is the problem, distance_scaling_matrices includes -inf
