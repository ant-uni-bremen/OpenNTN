...
"""
DISCLAIMER: THE TDL MODEL IS NOT YET FULLY DEFINED BY THE 3GPP. THUS, THE IMPLEMENTATION IS NOT YET PROVIDED. THIS FILE ONLY EXISTS TO 
...
class TDL(ChannelModel):
    ...
    @property
    def basestation_height(self):
        r"""Height of the basestation in m"""
        return self._basestation_height
