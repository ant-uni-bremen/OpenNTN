...
# Based on implementation of scenario UMi in Sionna TR38.901
#
"""Urban channel model from 3GPP TR38.811 specification"""

import tensorflow as tf

from . import SystemLevelChannel
from . import UrbanScenario


class Urban(SystemLevelChannel):
    # pylint: disable=line-too-long
    r"""Urban(carrier_frequency, ut_array, bs_array, direction, enable_pathloss=True, enable_shadow_fading=True, always_generate_lsp=False, dtype=tf.complex64)

    Urban channel model from 3GPP [TR38811]_ specification.

    Setting up a Urban model requires configuring the network topology, i.e., the
    UTs and BSs locations, UTs velocities, etc. This is achieved using the
    :meth:`~sionna.phy.channel.tr38811.Urban.set_topology` method. Setting a different
    ...
    The following code snippet shows how to setup an Urban channel model assuming
    an OFDM waveform:
    ...
    ...                       carrier_frequency = 3.5e9)
    >>> # Instantiating Urban channel model
    ...
    def __init__(self, carrier_frequency, ut_array, bs_array,
        ...
        # urban scenario
        scenario = UrbanScenario(carrier_frequency, ut_array, bs_array,
